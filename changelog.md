...
### Added
- Added volume and brightness level persistence across sessions using `AppPreferences`.
...
- Implemented `PlayerControlsState` to handle the player controls overlay visibility logic and auto-hide behaviors.
